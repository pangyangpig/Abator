...
public abstract class BaseDao extends SqlSessionDaoSupport implements IDao {
    ...
    public Integer delete(String keyId) throws DataAccessException {
        return this.getSqlSession().delete(this.getNameSpace() + ".delete", keyId);
    }
    ...
    public <T> List<T> listForObject(T t) throws DataAccessException {
        return this.getSqlSession().selectList(this.getNameSpace() + ".list", t);
    }

    public <T> Integer countForObject(T t) throws DataAccessException {
        return (Integer) this.getSqlSession().selectOne(this.getNameSpace() + ".count", t);
    }
    ...
    public <T extends BaseDomain> List<T> updateBatch(List<T> t, String updateSqlId) {
        return null;
    }
