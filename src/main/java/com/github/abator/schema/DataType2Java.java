...
public class DataType2Java {
	...
	dataTypeMap.put("tinyint", "int");/*-128到127*/
	dataTypeMap.put("smallint", "int");/*-32768到32767*/
	dataTypeMap.put("mediumint", "int");/*-8388608到8388607*/
	dataTypeMap.put("decimal", "double");/*压缩的“严格”定点数*/
	dataTypeMap.put("integer", "int");
	dataTypeMap.put("int", "int");/*-2147483648到2147483647*/
	dataTypeMap.put("bigint", "int");/*-9223372036854775808到9223372036854775807*/
